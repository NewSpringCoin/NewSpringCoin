...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("NewSpringCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("NewSpringCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("NewSpringCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NewSpringCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"5.200.47.41", "5.200.47.41"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("NewSpringCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("NewSpringCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("NewSpringCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("NewSpringCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NewSpringCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("NewSpringCoin-start");
